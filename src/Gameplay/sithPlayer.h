...
//static void (*sithPlayer_Tick)(sithPlayerInfo *playerInfo, flex_t a2) = (void*)sithPlayer_Tick_ADDR;
...
//static void (*sithPlayer_SetBinAmt)(int idx, flex_t a2) =(void*)sithPlayer_SetBinAmt_ADDR;
